...
export default function ResultModal({ visible, status, title, message, photoUri, onClose }: Props) {
  ...
  // No auto-dismiss and no backdrop/back-button dismiss (onRequestClose is a
  // no-op) — the employee must explicitly tap "Done" to close this, since an
  // unread result (especially a rejection or a flagged/pending notice)
  // disappearing on its own could be mistaken for a successful scan.
  return (
